...
import RequiredModuleFinder from '../../../src/linter/used_module_finder/requiredModuleFinder';
import { beforeEach, describe, it } from 'mocha';
import { expect } from 'chai';
import {AcornParseProps,  ModuleUsage, TranspilerConfigBuiltin , TranspilerConfigExternal} from '../../../src/types';
type ExampleBase = {
	filePath: string;
	filePattern: string;
	transpilers?: ( TranspilerConfigExternal) [];
...
const baseBabelExample: ExampleBase = {
	filePath: 'server.js',
	filePattern: '**/*.js',
	async setup(tmpDir: string) {
...
const baseCoffeeScriptExample:ExampleBase = {
	filePath: 'server.coffee',
	filePattern: '**/*.coffee',
	transpilers: [{ extension: '.coffee', module: 'coffeescript' }],
};
const baseJavaScriptExample:ExampleBase = {
	filePath: 'server.js',
	filePattern: '**/*.js',
};
