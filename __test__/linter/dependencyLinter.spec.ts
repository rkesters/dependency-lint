import DependencyLinter from '../../src/linter/dependencyLinter';
...
describe('DependencyLinter', function () {
	beforeEach(function () {
		...
		this.input = {
			listedModules: { dependencies: [], devDependencies: [], peerDependencies: [] },
			usedModules: [],
		};
	...
	describe('used as a dependency', function () {
		...
		describe('listed as devDependency', function () {
			...
			describe('ignored', function () {
				beforeEach(function () {
					this.options.ignoreErrors.shouldBeDependency.push(
						'myModule',
					);
					this.output.devDependencies.push({
						name: 'myModule',
	...
	describe('used as a devDependency', function () {
		...
		describe('listed as dependency', function () {
			...
			describe('ignored', function () {
				beforeEach(function () {
					this.options.ignoreErrors.shouldBeDevDependency.push(
						'myModule',
					);
					this.output.dependencies.push({
						name: 'myModule',
	...
	describe('dependency-lint', () =>
		describe('not used, listed as devDependency', function () {
			beforeEach(function () {
				this.input.listedModules.devDependencies.push(
					'@rkesters/dependency-lint',
				);
				this.output.devDependencies.push({
